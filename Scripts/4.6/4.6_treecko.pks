...
addpokemon 0X115 0x5 NONE 0x0 0x0 0x0
disappear 0x06
textcolor GREY
copyvar 0x8012 0x8013
fanfare 0x13E
setvar 0x4031 0x06 '0x4031 ulozeni cisla startovniho pkmna
setvar 0x4011 0x08
message @pok1
callstd MSG_NOCLOSE
waitfanfare
...
message @rival3
callstd MSG_NORMAL
trainerbattle 0x9 0x002 0x3 @loser @winner 'loser - rival prohral
...
#org @mespok
= \v\h01: A wood gecko Pok\emon,\nTreecko. Do I stick with it?
...
#org @position
M walk_up walk_right walk_right look_down end
...
#org @rival1
= \v\h06: You can go if you want\nto for all I care.\pGrandfather decided that I should\ntake one of these Pok\emon.\pSince you have already stolen\nTreecko it's only logical\pthat I will pick the one\nwhich is sure to be strong\lagainst yours - Charmander.

#org @gopick
M walk_left walk_left walk_up walk_up walk_up walk_up look_left end
...
#org @walkback
M walk_down walk_down walk_down walk_down walk_right walk_right look_up end

#org @watchback
M pause_long pause_long look_left pause_long pause_long pause_long look_down end
